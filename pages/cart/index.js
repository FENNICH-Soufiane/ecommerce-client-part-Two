              ...
              <div className="mt-8 flex justify-end border-t border-gray-100 pt-8">
                <div className=" max-w-md space-y-4">
                  ...
                  <div className="flex justify-end">
                    <Link
                      className="group flex items-center justify-between gap-4 rounded-lg border border-current px-5 py-3 text-primary transition-colors hover:bg-primary focus:outline-none focus:ring active:bg-primary"
                      href="/products"
                    >
                      ...
                      <span className="shrink-0 rounded-full border border-primary bg-white p-2 group-active:border-primary">
                        <svg
